...
export const HourglassIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M5 22h14"></path><path d="M5 2h14"></path><path d="M17 2v6l-5 4-5-4V2h10z"></path><path d="M7 16l5-4 5 4v6H7v-6z"></path>
  </svg>
);
...
export const RequisitionIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const AdIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 11l18-5v12L3 14v-3z"></path>
      <path d="M11.6 16.8a3 3 0 1 1-5.2-3.6 3 3 0 0 1 5.2 3.6z"></path>
      <path d="M11.6 16.8L3 14"></path>
    </svg>
);
  
export const ApplicationIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
      <polyline points="14 2 14 8 20 8"></polyline>
...
export const ApprovalIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const BuildingIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <line x1="8" y1="9" x2="8" y2="9" strokeWidth="2.5"></line>
    <line x1="12" y1="9" x2="12" y2="9" strokeWidth="2.5"></line>
    <line x1="16" y1="9" x2="16" y2="9" strokeWidth="2.5"></line>
    <line x1="8" y1="13" x2="8" y2="13" strokeWidth="2.5"></line>
    <line x1="12" y1="13" x2="12" y2="13" strokeWidth="2.5"></line>
    <line x1="16" y1="13" x2="16" y2="13" strokeWidth="2.5"></line>
    <line x1="8" y1="17" x2="8" y2="17" strokeWidth="2.5"></line>
    <line x1="12" y1="17" x2="12" y2="17" strokeWidth="2.5"></line>
    <line x1="16" y1="17" x2="16" y2="17" strokeWidth="2.5"></line>
  </svg>
);
